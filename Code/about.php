...
<div class="row">
  <div class="column">
    <div class="card">
      <img src="Images/index1.jpg" alt="Jane" style="width:100%">
      <div class="container">
        <h2>Rituraj Choudhury</h2>
        <p class="title">Student</p>
        <p><i>Department of Information Technology, Sikkim Manipal Institute of Technology,Majhitar,Sikkim</i></p>
        <p>Email: <Strong>riturajcoudhury@gmail.com</Strong></p>
  ...
  <div class="column">
    <div class="card">
      <img src="Images/index.jpg" alt="John" style="width:100%">
      <div class="container">
        <h2>Drubajyoti Choudhury</h2>
        <p class="title">Student</p>
        <p><i>Department of Information Technology, Sikkim Manipal Institute of Technology,Majhitar,Sikkim</i></p>
        <p>Email: <Strong>drubajyoti01@gmail.com</Strong></p>
